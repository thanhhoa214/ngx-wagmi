...
export type InjectChainIdParameters<config extends Config = Config> = ConfigParameter<config>;

export type InjectChainIdReturnType<config extends Config = Config> = GetChainIdReturnType<config>;

export function injectChainId<config extends Config = ResolvedRegister['config']>(
